(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ? factory(exports, require('react'), require('react-query'))
    : typeof define === 'function' && define.amd
      ? define(['exports', 'react', 'react-query'], factory)
      : ((global = global || self),
        factory(
          (global.ReactQueryDevtools = {}),
          global.React,
          global.ReactQuery
        ));
  ...
  function useLocalStorage(key, defaultValue) {
    ...
    var setter = React__default.useCallback(
      function (updater) {
  ...
  function useSafeState(initialState) {
    ...
    var safeSetState = React__default.useCallback(
      function (value) {
  ...
  function ReactQueryDevtools(_ref) {
    ...
    var _closeButtonProps$sty = closeButtonProps.style,
      ...
      otherCloseButtonProps = _objectWithoutPropertiesLoose(closeButtonProps, [
        'style',
        'onClick',
      ]);
    ...
    var _toggleButtonProps$st = toggleButtonProps.style,
      ...
      otherToggleButtonProps = _objectWithoutPropertiesLoose(
        toggleButtonProps,
        ['style', 'onClick']
  ...
  var ReactQueryDevtoolsPanel = /*#__PURE__*/ React__default.forwardRef(
    function ReactQueryDevtoolsPanel(props, ref) {
      ...
      var _props$isOpen = props.isOpen,
        ...
        panelProps = _objectWithoutPropertiesLoose(props, [
          'isOpen',
          'styleNonce',
          'setIsOpen',
          'handleDragStart',
      ...
      var _useLocalStorage3 = useLocalStorage(
      ...
      var _useLocalStorage5 = useLocalStorage(
      ...
      var sortFn = React__default.useMemo(
        function () {
          return sortFns[sort];
        },
        [sort]
      ...
      var _useLocalStorage6 = useLocalStorage(
      ...
      var queries = React__default.useMemo(
        function () {
      ...
      var activeQuery = React__default.useMemo(
        function () {
